...
public class BookDirectoryTestSuite {
    ...
    @Test
    public void testListBooksInHandsWithConditionZeroBooks() {
        // Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        ...
        // When
        List<Book> theListOfBooks0 = bookLibrary.listBooksInHandsOf(testLibraryUser);
    ...
    @Test
    public void testListBooksInHandsWithConditionOneBook() {
        // Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser testLibraryUser = new LibraryUser("Adam", "Kot", "80010112345");
    ...
    @Test
    public void testListBooksInHandsWithConditionFiveBooks() {
        // Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser testLibraryUser = new LibraryUser("Adam", "Kot", "80010112345");
